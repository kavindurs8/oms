...
export default function WhatsAppWidget() {
    ...
    const whatsappNumber = "94777672155"; // Sri Lankan number: +94 77 767 2155
    const message = "Hello! I'm interested in Storemate OMS for my business. Can you provide more information?";
